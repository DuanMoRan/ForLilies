...
public class StudentController{
    ...
    public ResponseData findAll(@RequestBody Student student) {
        ...
        if(students.isEmpty()) return new ResponseData(false , students , "查询失败");
        else return new ResponseData(true, students, "查询成功");
    }
    ...
    public ResponseData decCourse(@RequestBody SelectCourse course) {
        ...
        }else return new ResponseData(false, null, "移除失败");
    }
    ...
    public ResponseData register(@RequestBody Student student) {
        if(service.register(student)) return new ResponseData(true, null, "注册成功");
        else return new ResponseData(false, null, "注册失败");
    }
